...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_BJVF")

  // remove field
  collection.fields.removeById("_clone_qpF0")

  // remove field
  collection.fields.removeById("_clone_56sX")

  // remove field
  collection.fields.removeById("_clone_UTUH")

  // remove field
  collection.fields.removeById("_clone_Jy2D")

  // remove field
  collection.fields.removeById("_clone_BoYw")
