<script lang="ts">
	...
	import { Toggler } from '#lib/components/base/toggler/index.js'; // Bileşeninizi import ettiğiniz yer
							...
							<div style="margin-bottom: 1rem;">
								<button
									...
									onclick={(e: MouseEvent) => {
										...
										const pointer = target.dataset.pointer ?? 'mouse';
										const active = target.dataset.active === 'active';
										if (pointer !== 'keyboard' && active) return;
										toggl?.toggle();
									}}
								>
