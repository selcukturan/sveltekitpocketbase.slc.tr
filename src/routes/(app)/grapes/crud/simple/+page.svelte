					...
					<DrawerFormContent.Content boundary>
						...
						>
							{#snippet inputs({ inputData })}
								...
								<input.Text label="text_required" field={updateForm.fields.text_required} value={inputData.text_required} />
								<input.Text label="text_optional" field={updateForm.fields.text_optional} value={inputData.text_optional} />
							{/snippet}
